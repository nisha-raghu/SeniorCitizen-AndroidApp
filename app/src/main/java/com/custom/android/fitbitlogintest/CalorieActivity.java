...
public class CalorieActivity extends Activity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String CalorieUrl = "https://05elgrj7u0.execute-api.us-east-2.amazonaws.com/caloriemob/caloriemob";
        String result;
        CalorieActivity.HttpGetData h = new CalorieActivity.HttpGetData();
        try {
            result= h.execute(CalorieUrl).get();
    ...
    public class HttpGetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                JSONArray arr = res.getJSONArray("activities-calories");
                ...
                BarDataSet dataSet = new BarDataSet(BarEntry, "Calories");
